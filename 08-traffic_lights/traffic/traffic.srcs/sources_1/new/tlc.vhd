...
entity tlc is
  port (
    ...
    --spdbtns : in    std_logic;
    --spdbtnw : in    std_logic
  );
end entity tlc;
...
begin
  ...
  --p_speed_button : process (sig_state) is
  --begin
  --
  --if (spdbtns = '1' and spdbtnw = '0') then
  --  sig_state <= WEST_WAIT;
  --  sig_cnt   <= (others => '0');
  --elsif (spdbtns = '0' and spdbtnw = '1') then
  --  sig_state <= SOUTH_WAIT;
  --  sig_cnt   <= (others => '0');
  --else
  --  sig_state <= WEST_STOP;
